...
| [`run_once`](#liaise.tick.run_once)(subjects, store, \*, global_config)     | One tick over `subjects` (slug to [`Subject`](liaise.subjects.html.md#liaise.subjects.Subject)), on the ledger `store`. |
...
alias of `Callable`[[[`Sequence`](https://docs.python.org/3/library/collections.abc.html#collections.abc.Sequence)[[`Case`](liaise.model.html.md#liaise.model.Case)]], [`Iterable`](https://docs.python.org/3/library/collections.abc.html#collections.abc.Iterable)[[`Iterable`](https://docs.python.org/3/library/collections.abc.html#collections.abc.Iterable)[[`Case`](liaise.model.html.md#liaise.model.Case)]]]

### liaise.tick.WorkspaceFactory

the
workspace seam (see [`liaise.workspace.workspace_for()`](liaise.workspace.html.md#liaise.workspace.workspace_for)).

* **Type:**
  `(subject, *, lock_dir, sessions_dir, own_pids) -> SharedCheckout | None`

alias of `Callable`[[…], [`SharedCheckout`](liaise.workspace.html.md#liaise.workspace.SharedCheckout) | [`None`](https://docs.python.org/3/builtins/constants.html#None)]
