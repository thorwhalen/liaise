...
Everything goes through a [`Ledger`](liaise.ledger.md#liaise.ledger.Ledger), so a dry-run ledger
...
#### hold *: [Hold](liaise.model.md#liaise.model.Hold)*
...
* **Return type:**
  [`list`](https://docs.python.org/3/builtins/stdtypes.html#list)[[`Hold`](liaise.model.md#liaise.model.Hold)]
