...
JSON), the [`Finding`](liaise.detect.html.md#liaise.detect.Finding) records the detectors made, the run’s
...
`bcc`, `attachments` and `case_id` ([`liaise.gate.Outbound`](liaise.gate.html.md#liaise.gate.Outbound) is one).
...
[`Finding`](liaise.detect.html.md#liaise.detect.Finding) records or their dicts. `identities` maps an address
...
#### *property* leaks *: [tuple](https://docs.python.org/3/builtins/stdtypes.html#tuple)[[Finding](liaise.detect.html.md#liaise.detect.Finding), ...]*
...
* **Return type:**
  [`tuple`](https://docs.python.org/3/builtins/stdtypes.html#tuple)[[`Finding`](liaise.detect.html.md#liaise.detect.Finding), [`...`](https://docs.python.org/3/builtins/constants.html#Ellipsis)]
