...
see [`liaise.subjects`](liaise.subjects.html.md#module-liaise.subjects)). [`migrate_config()`](#liaise.migrate.migrate_config) groups the partners by repo, one
...
written is loaded back with [`load_subject()`](liaise.subjects.html.md#liaise.subjects.load_subject), and one that does
