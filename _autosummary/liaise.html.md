...
[`liaise.errors.classify()`](liaise.errors.html.md#liaise.errors.classify), given `stderr.log` and `timed_out` (which the
...
* **Return type:**
  [`Optional`](https://docs.python.org/3/library/typing.html#typing.Optional)[[`RunResult`](liaise.model.html.md#liaise.model.RunResult)]
...
* **Return type:**
  [`Health`](liaise.model.html.md#liaise.model.Health)
...
`results` maps a case id to the [`RunResult`](liaise.model.html.md#liaise.model.RunResult) its runs return,
...
is the whole prompt (see [`liaise.prompt.compose_case_prompt()`](liaise.prompt.html.md#liaise.prompt.compose_case_prompt)), `cwd` is where
...
outside [`PERMISSIONS`](liaise.model.html.md#liaise.model.PERMISSIONS).

* **Return type:**
  [`AccessDecision`](liaise.access.html.md#liaise.access.AccessDecision)
...
`needs-partner` waits for its partner to write after it (see [`liaise.tick`](liaise.tick.html.md#module-liaise.tick)).
...
conversation would starve each other: [`load_subjects()`](liaise.subjects.html.md#liaise.subjects.load_subjects) refuses
such a configuration.

`resolver` maps a sender’s address to a person (see [`liaise.access`](liaise.access.html.md#module-liaise.access)). `now`
...
* **Return type:**
  [`GlobalConfig`](liaise.config.html.md#liaise.config.GlobalConfig)
...
* **Return type:**
  [`dict`](https://docs.python.org/3/builtins/stdtypes.html#dict)[[`str`](https://docs.python.org/3/builtins/stdtypes.html#str), [`Subject`](liaise.subjects.html.md#liaise.subjects.Subject)]
...
Raises [`ConfigError`](liaise.config.html.md#liaise.config.ConfigError) when the 0.0.x config does not load.

* **Return type:**
  [`MigrationPlan`](liaise.migrate.html.md#liaise.migrate.MigrationPlan)
...
* **Return type:**
  [`list`](https://docs.python.org/3/builtins/stdtypes.html#list)[`Union`[[`Send`](liaise.outcomes.html.md#liaise.outcomes.Send), [`Transition`](liaise.outcomes.html.md#liaise.outcomes.Transition), [`NotifyOperator`](liaise.outcomes.html.md#liaise.outcomes.NotifyOperator), [`StoreDraft`](liaise.outcomes.html.md#liaise.outcomes.StoreDraft), [`Deliver`](liaise.outcomes.html.md#liaise.outcomes.Deliver), [`Defer`](liaise.outcomes.html.md#liaise.outcomes.Defer), [`DigestNote`](liaise.outcomes.html.md#liaise.outcomes.DigestNote)]]
...
- `processor`: a [`Processor`](liaise.processor.html.md#liaise.processor.Processor), by default
  `ClaudeHeadless(runs_dir=<state_dir>/runs)`;
- `resolver`: who a channel address is ([`liaise.access.resolve_person()`](liaise.access.html.md#liaise.access.resolve_person));
- `workspace`: a subject’s checkout ([`liaise.workspace.workspace_for()`](liaise.workspace.html.md#liaise.workspace.workspace_for)), with
...
* **Return type:**
  [`TickReport`](liaise.tick.html.md#liaise.tick.TickReport)
...
| [`vet`](liaise.vet.html.md#module-liaise.vet)               | Vetting a draft outside any case: the gate's verdict, and nothing sent (discussion 32, §5.8).                        |
