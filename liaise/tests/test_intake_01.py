"""Tests for liaise.intake.intake (0.1): polling, dedupe, routing, access, adoption and dry runs.

Every channel is a fake from liaise.testing, heard through correspond's own listen. The
0.0.x functions of liaise.intake keep their tests in test_intake.py. acquaint is made
unimportable, so no test reads real people records.
"""
...
from liaise import intake as intake_module
