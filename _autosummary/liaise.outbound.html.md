...
[`liaise.policy.evaluate()`](liaise.policy.html.md#liaise.policy.evaluate) is pure: it takes a message, an audience, a disclosure, the
...
[`liaise.gate.outbound_policy()`](liaise.gate.html.md#liaise.gate.outbound_policy) hands them over through [`judge()`](#liaise.outbound.judge):
...
[`liaise.detect.detect()`](liaise.detect.html.md#liaise.detect.detect)). `disclosure`, `detectors` and `resolver` are the
